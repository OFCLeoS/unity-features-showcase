...
The repository does not contain a complete Unity project; scripts are provided primarily to demonstrate implementation and architecture, and are not intended to run independently (yet).
